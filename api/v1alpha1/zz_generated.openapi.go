		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"serverAddress": {
						SchemaProps: spec.SchemaProps{
							Description: "serverAddress is the address of an external gRPC server form which metrics can be fetched",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "serverMetadata is gRPC request metadata sent along with the request",
							Type:        []string{"object"},
